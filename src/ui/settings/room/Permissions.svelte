...
const info = {
  ...
  name:     { name: "Change Name",     description: `The minimum power required to change this ${room.type === "m.space" ? "space" : "room"}'s name.` },
  topic:    { name: "Change Topic",    description: `The minimum power required to change this ${room.type === "m.space" ? "space" : "room"}'s topic.` },
  avatar:   { name: "Change avatar",   description: `The minimum power required to change this ${room.type === "m.space" ? "space" : "room"}'s avatar.` },
